...
### 5. Education
- LaSalle — Grado en Ingeniería Informática (Starting 2026-27)
- Clean, minimal card
...
## Trilingual System
- Content object with `es`, 'ca' and `en` keys for all translatable strings
- Toggle button in nav (ES/EN/CA)
...
Formalized by Open Design from candidate 73fe0e52-dc1e-4112-8337-a2089b3944a1.
